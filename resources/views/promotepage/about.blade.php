...
?>
    ...
    <div class="breadcrumb-area">
        <!-- Top Breadcrumb Area -->
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(template/promote/img/bg-img/24.jpg);">
            <h2>ABOUT US</h2>
        </div>
    ...
    <section class="cool-facts-area bg-img section-padding-100-0" style="background-image: url(template/promote/img/bg-img/cool-facts.png);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="{{ asset('template/promote/img/core-img/cf1.png') }}" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="{{ asset('template/promote/img/core-img/cf2.png') }}" alt="">
                        </div>
                        <div class="cf-content">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="{{ asset('template/promote/img/core-img/cf3.png') }}" alt="">
                        </div>
                        <div class="cf-content">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="{{ asset('template/promote/img/core-img/cf4.png') }}" alt="">
                        </div>
                        <div class="cf-content">
        ...
        <div class="side-img wow fadeInUp" data-wow-delay="500ms">
            <img src="{{ asset('template/promote/img/core-img/pot.png') }}" alt="">
        </div>
    </section>
    <!-- ##### Cool Facts Area End ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        ...
                        <div class="team-member-thumb">
                            <img src="{{ asset('template/promote/img/bg-img/team1.png') }}" alt="">
                            <!-- Social Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="{{ asset('template/promote/img/bg-img/team2.png') }}" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="{{ asset('template/promote/img/bg-img/team3.png') }}" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="{{ asset('template/promote/img/bg-img/team4.png') }}" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
